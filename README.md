...
Finally, this implementation uses the [ASP.NET Core Docker sample web app](https://github.com/nholuongut/dotnet-docker/tree/master/samples/aspnetapp) as an example workload. This workload is purposefully uninteresting, as it is here exclusively to help you experience the baseline infrastructure.
...
- [AKS baseline for multiregion clusters](https://github.com/nholuongut/aks-secure-baseline-multi-region)
- [AKS baseline for regulated workloads](https://github.com/nholuongut/aks-secure-baseline-regulated)
- [AKS baseline for microservices](https://github.com/nholuongut/aks-fabrikam-dronedelivery)
- [Azure landing zones, enterprise-scale reference implementation using Terraform](https://github.com/nholuongut/aks-terraform-workspaces)
...
- [dapr](https://github.comnholuongut/dapr)
...
This project has adopted the [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/). For more information see the [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) or contact <luongutnho@hotmail.com> with any additional questions or comments.
